        ...
        try {
            ...
            GlobalTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'RHODVICKEZ-MD~' + stringSession;  // Prepend your name to the session ID
                    ...
                    await GlobalTechInc.sendMessage(userJid, { text: '`HELLO THERE! 👋` \n\n`DO NOT SHARE YOUR SESSION ID WITH ANYONE.`\n\n`PUT THE ABOVE IN SESSION_ID VAR`\n\n`THANKS FOR USING RHODVICKEZ-MD BOT`\n\n `JOIN SUPPORT CHANNEL1:-https://whatsapp.com/channel/0029VasiOoR3bbUw5aV4qB31. CHANNEL2:-https://whatsapp.com/channel/0029VabySTR9Bb5upWFhMv1N`\n' });
